        ...
        <div className="relative w-full rounded-2xl bg-slate-900/60 backdrop-blur-xl border border-white/10 overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.5)] transition-all duration-300 hover:-translate-y-1 hover:shadow-indigo-500/10 group">
            ...
            <div className="p-5 sm:p-6 flex flex-col gap-5 relative z-10">
                ...
                <div className="flex items-center justify-between pb-4 border-b border-white/5">
                    ...
                    <div className={`px-3 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1.5 border ${
                        ...
                        <div className={`w-1.5 h-1.5 rounded-full ${
                            isDelivered ? 'bg-emerald-400' : isCancelled ? 'bg-red-400' : 'bg-indigo-400 animate-pulse'
                        }`}></div>
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-white/5">
                    <button className="flex-1 flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold py-2.5 px-4 rounded-xl transition-all duration-300 shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 active:scale-[0.98]">
                        <FiBox className="text-lg" />
                        <span>Track Order</span>
                    </button>
                    <button className="flex-1 flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-200 border border-white/5 hover:border-white/10 text-sm font-semibold py-2.5 px-4 rounded-xl transition-all duration-300 active:scale-[0.98]">
